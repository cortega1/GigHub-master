    ...
    public class GigsController : Controller
    {
        ...
        public ActionResult Details(int id)
        {
            ...
            if (User.Identity.IsAuthenticated)
            {
                ...
                viewModel.IsAttending = _unitOfWork.Attendances.CheckIfUserIsAttending(id, userId);

                viewModel.IsFollowing = _unitOfWork.Followers.CheckIfUserIsFollowing(gig.ArtistId, userId);
            }
